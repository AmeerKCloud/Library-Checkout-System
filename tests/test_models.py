...
class Library:
    ...
    def borrow_book(self):                                                                  #⬅️ Just completed this funct. Appears to be working as intended.
        ...
        while len_book_list > 0:
            ...
            for item in self.json_books_data_list:
                len_book_list -= 1
                print(f"Books left to check: {len_book_list}")                             #⬅️ For testing & validation purposes only.
...
# TODO:
# - Finish 'User' class methods: 'borrow_books()' & 'returned_books()'
...
# - But in our case, we want all objects to share the same main data dict, ie 'user_books_data'
...
# ✅ The solution in this use-case was to initiate the data dict as a 'class variable' without the 'self.', ie user_books_data = {}, & outside of '__init__()'
...
# - you want global state tied to a class

# Examples:
# - all users in a system
# - a shared dictionary of borrowed books
